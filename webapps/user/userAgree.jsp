...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다. 
			...
			<div class="form-check">
				...
				<label for="ck1" class="form-check-label">이용약관에 동의합니다</label><br><br>
			</div>
			<h1 class="title">가입약관</h1>
			<article class="agree_fr">
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
			...
			<div class="form-check">
				...
				<label for="ck2" class="checkbox form-check-label">가입약관에 동의합니다</label><br><br>
			</div>
			<div class="form-check">
				<label for="ck3" onclick="protocol()" class="form-check-label">전체 약관에 동의합니다.</label><br><br>
			</div>
			<button type="button" id="btn1" name="btn1" class="button is-primary">다음 단계</button>
			<script>
			$("#ck1").val();
			$("#ck2").val();
			$("#btn1").val();
